import { ActionRowBuilder, ChannelType, PermissionsBitField } from "discord.js";
...
export default {
    ...
    function: async function ({ button }) {
        if (!config.reportQuestions.length)
            return await button.reply({ content: ":x: **The report form is not set up.**", ephemeral: true });
